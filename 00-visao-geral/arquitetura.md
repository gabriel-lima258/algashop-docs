...
| **Destaques** | Modelagem documental, Spring Boot 4, REST Docs, contract-driven development |
...
Mensageria (RabbitMQ/Kafka) entre serviços. Os domain events hoje são **internos** ao `ordering` — publicados e consumidos dentro do próprio processo via `ApplicationEventPublisher` do Spring. É o próximo passo natural da evolução.
